...
export function OrderPlacedEmail({ order }: { order: OrderEmailData }) {
  return (
    <Html lang="pl">
      <Head />
      <Preview>
        Zamówienie #{order.id.slice(-8).toUpperCase()} zostało złożone
      </Preview>
        ...
        <Container style={{ maxWidth: 600, margin: "0 auto" }}>
          ...
          <Section style={{ background: CARD_BG, padding: "32px", borderLeft: `1px solid ${BORDER}`, borderRight: `1px solid ${BORDER}` }}>
            ...
            <Text style={{ color: MUTED, margin: "0 0 24px", fontSize: 15 }}>
              Twoje zamówienie zostało przyjęte. Po zaksięgowaniu płatności
